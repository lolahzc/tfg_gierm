...
class Position {
  ...
  public:
    ...
    void update(float x, float y, float z);
		...
		friend float distance(Position&, mission_planner::msg::Waypoint&);
		friend float distance(mission_planner::msg::Waypoint&, Position&);
		friend float distance2D(Position&, Position&);
		friend float distance2D(Position&, mission_planner::msg::Waypoint&);
		friend float distance2D(mission_planner::msg::Waypoint&, Position&);
		friend Position closePose(Position&, Position&, float);
		friend Position closePose(Position&, mission_planner::msg::Waypoint&, float);
		friend Position closePose2D(Position&, Position&, float);
		friend Position closePose2D(Position&, mission_planner::msg::Waypoint&, float);
		//Getters
		std::string getID();
		float getX();
		float getY();
...
float distance(Position&, mission_planner::msg::Waypoint&);
float distance(mission_planner::msg::Waypoint&, Position&);
float distance(mission_planner::msg::Waypoint&, mission_planner::msg::Waypoint&);
float distance2D(Position&, Position&);
float distance2D(Position&, mission_planner::msg::Waypoint&);
float distance2D(mission_planner::msg::Waypoint&, Position&);
float distance2D(mission_planner::msg::Waypoint&, mission_planner::msg::Waypoint&);
Position closePose(Position& orig, Position& dest, float dist);
Position closePose(Position&, mission_planner::msg::Waypoint&, float);
Position closePose2D(Position&, Position&, float);
Position closePose2D(Position&, mission_planner::msg::Waypoint&, float);
mission_planner::msg::Waypoint central_position(std::vector<mission_planner::msg::Waypoint>&);
...
class Task {
  ...
  public:
    ...
    virtual std::string getUGVID();
		...
		virtual std::vector<mission_planner::msg::Waypoint> getInspectWaypoints();
    ...
    virtual void print(std::ostream& os) const;
		//Setters
		virtual void setWaypoints(std::vector<mission_planner::msg::Waypoint> waypoints);
...
class Inspect : public Task {
  protected:
		std::vector<mission_planner::msg::Waypoint> waypoints_;
		std::vector<std::string> agent_list_;
  public:
    Inspect();
    Inspect(std::string task_id, std::vector<mission_planner::msg::Waypoint> waypoints);
    Inspect(std::string task_id, std::vector<mission_planner::msg::Waypoint> waypoints, 
				std::vector<std::string> agent_list);
    ...
    std::string getID();
    char getType();
		std::vector<mission_planner::msg::Waypoint> getInspectWaypoints();
		std::vector<std::string> getAgentList();
    void print(std::ostream& os) const;
		//Setters
		void setWaypoints(std::vector<mission_planner::msg::Waypoint> waypoints);
		void setAgentList(std::vector<std::string> agent_list);
		void updateParams(classes::Task* task);
};
...
class InspectPVArray : public Task {
  ...
  public:
    InspectPVArray();
    InspectPVArray(std::string task_id, std::vector<mission_planner::msg::Waypoint> waypoints);
    InspectPVArray(std::string task_id, std::vector<mission_planner::msg::Waypoint> waypoints, 
				std::vector<std::string> agent_list);
