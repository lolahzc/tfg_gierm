...
float classes::distance(Position& p1, mission_planner::msg::Waypoint& p2){
  return sqrt(pow(p1.x_ - p2.x, 2) + pow(p1.y_ - p2.y, 2) + pow(p1.z_ - p2.z, 2));
}

float classes::distance(mission_planner::msg::Waypoint& p1, Position& p2){
  return sqrt(pow(p1.x - p2.x_, 2) + pow(p1.y - p2.y_, 2) + pow(p1.z - p2.z_, 2));
}

float classes::distance(mission_planner::msg::Waypoint& p1, mission_planner::msg::Waypoint& p2){
...
float classes::distance2D(Position& p1, mission_planner::msg::Waypoint& p2){
  return sqrt(pow(p1.x_ - p2.x, 2) + pow(p1.y_ - p2.y, 2));
}

float classes::distance2D(mission_planner::msg::Waypoint& p1, Position& p2){
  return sqrt(pow(p1.x - p2.x_, 2) + pow(p1.y - p2.y_, 2));
}

float classes::distance2D(mission_planner::msg::Waypoint& p1, mission_planner::msg::Waypoint& p2){
...
Position classes::closePose(Position& orig, mission_planner::msg::Waypoint& dest, float dist){
...
Position classes::closePose2D(Position& orig, mission_planner::msg::Waypoint& dest, float dist){
...
mission_planner::msg::Waypoint classes::central_position(std::vector<mission_planner::msg::Waypoint>& waypoints){
...
std::vector<mission_planner::msg::Waypoint> Task::getInspectWaypoints(){
  return std::vector<mission_planner::msg::Waypoint>();
}
...
//Class Task Setters
void Task::setWaypoints(std::vector<mission_planner::msg::Waypoint> waypoints){return;}
...
Inspect::Inspect(std::string task_id, std::vector<mission_planner::msg::Waypoint> waypoints) : 
...
std::vector<mission_planner::msg::Waypoint> Inspect::getInspectWaypoints(){return waypoints_;}
...
void Inspect::setWaypoints(std::vector<mission_planner::msg::Waypoint> waypoints){
...
InspectPVArray::InspectPVArray(std::string task_id, std::vector<mission_planner::msg::Waypoint> waypoints) : 
  Task(task_id), waypoints_(waypoints) {}
InspectPVArray::InspectPVArray(std::string task_id, std::vector<mission_planner::msg::Waypoint> waypoints, 
    std::vector<std::string> agent_list) : Task(task_id), waypoints_(waypoints), agent_list_(agent_list) {}
...
std::vector<mission_planner::msg::Waypoint> InspectPVArray::getInspectWaypoints(){return waypoints_;}
...
void InspectPVArray::setWaypoints(std::vector<mission_planner::msg::Waypoint> waypoints){
  waypoints_ = waypoints;
  return;
}
