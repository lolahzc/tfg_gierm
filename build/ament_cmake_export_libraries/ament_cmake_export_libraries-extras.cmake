...
set(_exported_libraries "mission_planner__rosidl_generator_c;mission_planner__rosidl_typesupport_c;mission_planner__rosidl_typesupport_cpp")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'mission_planner' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND mission_planner_LIBRARIES ${_cfg} "${_lib}")
